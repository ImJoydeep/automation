...
client_name = 'Judith Bright'
dbx_path = '/Client/Judith Bright/Internal Files/Reporting/'
...
def update_masterlist(uri,client_id,client_esp):
    ...
    dedup = updated_masterlist.loc[(updated_masterlist['Date'] >= '2022-01-01')].drop_duplicates(subset=['Date','Name','Subject_Line','Segment','Variant','Flow_Message_Name'], keep='last').sort_values('Date')
    ...
    dbx_rename = {"Name":"Name","Campaign":"Campaign","Mailing":"Mailing","Test_Type":"Test Type","Variant":"Variant","Type_2":"Type 2","Offer":"Offer","Subject_Line":"Subject Line","Segment":"Segment","Date":"Date","ESP":"ESP","Type_0":"Type 0","Type_1":"Type 1","Send_Weekday":"Send Weekday","Sent":"Sent","Orders":"Orders","Revenue":"Revenue","Opens":"Opens","Total_Opens":"Total Opens","Clicks":"Clicks","Total_Clicks":"Total Clicks","Unsub":"Unsub","Complaints":"Complaints","Delivered":"Delivered","Total_Bounces":"Total Bounce","Campaign_ID":"Campaign ID","Winning_Variant_question_":"Winning Variant?","Flow_Message_ID":"Flow Message ID","Flow_ID":"Flow ID","Flow_Message_Name":"Flow Message Name","GA_Revenue":"GA Revenue","GA_Orders":"GA Orders","GA_Sessions":"GA Sessions"}
    dbx_schema = ["Name","Campaign","Mailing","Test Type","Variant","Type 2","Offer","Subject Line","Segment","Date","ESP","Type 0","Type 1","Send Weekday","Sent","Orders","Revenue","Opens","Total Opens","Clicks","Total Clicks","Unsub","Complaints","Delivered","Total Bounce","Campaign ID","Winning Variant?","Flow Message ID","Flow ID","Flow Message Name","GA Revenue","GA Orders","GA Sessions"]
...
def update_bigquery(uri,client_id,client_esp):
    ...
    all_cols = ["Date","Name","Campaign","Mailing","Variant","Subject_Line","Segment","Type_0","Type_1","Type_2","Offer","Segment_Engagement","Segment_BNB","Segment_Freq","Test_Type","Sent","Delivered","Opens","Clicks","Revenue","Orders","GA_Revenue","GA_Orders","GA_Sessions","AA_Visits","AA_Revenue","AA_SFCC_Demand","AA_Orders","AA_Mobile_Visits","Units","Product_Margin","Total_Margin","Unsub","Complaints","Hard_Bounces","Soft_Bounces","Total_Bounces","ESP","Send_Weekday","Total_Opens","Total_Clicks","Campaign_ID","Winning_Variant_question_","Flow_Message_ID","Flow_ID","Flow_Message_Name","Error","Original_Segment","FISCAL_YEAR"]
