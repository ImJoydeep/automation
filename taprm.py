...
client_name = 'TapRM'
dbx_path = '/Client/TapRM/Internal Files/Reporting/'
...
def update_masterlist(uri,client_id,client_esp):
    ...
    str_cols = ['Campaign','Mailing','Variant','Subject_Line','Segment','Type_2','Campaign_ID','ESP','Flow_Message_ID','Flow_ID',]
    ...
    #updated_masterlist = updated_masterlist.drop_duplicates(subset=['Date','Name','Subject_Line','Segment','Variant','Flow_Message_Name'], keep='last').sort_values('Date')
    #updated_masterlist.loc[(updated_masterlist['Date'] >= '2022-01-01')].drop_duplicates(subset=['Date','Name','Subject_Line','Segment','Variant','Flow_Message_Name'], keep='last').sort_values('Date')

    missing_str_cols = ['Segment_Engagement','Segment_BNB','Segment_Freq','Error','Original_Segment','by_Variant']
    missing_int_cols =['AA_Visits','AA_Revenue','AA_SFCC_Demand','AA_Orders','AA_Mobile_Visits','Units','Product_Margin','Total_Margin','Hard_Bounces','Soft_Bounces','Bounces','FISCAL_YEAR','GA_Session']
    ...
    cols_all = ['Date','Name','Campaign','Mailing','Variant','Subject_Line','Segment','Type_0','Type_1','Type_2','Offer','Segment_Engagement','Segment_BNB','Segment_Freq','Test_Type','Sent','Delivered','Opens','Clicks','Revenue','Orders','GA_Revenue','GA_Orders','GA_Sessions','AA_Visits','AA_Revenue','AA_SFCC_Demand','AA_Orders','AA_Mobile_Visits','Units','Product_Margin','Total_Margin','Unsub','Complaints','Hard_Bounces','Soft_Bounces','Total_Bounces','ESP','Send_Weekday','Total_Opens','Total_Clicks','Bounces','Campaign_ID','Flow_Message_ID','Flow_ID','GA_Session','Error','Original_Segment','FISCAL_YEAR']
    ...
    #update_masterlist['FISCAL_YEAR_START'] = d + timedelta(-d.isoweekday())
    ...
    # Making Dropbox File
    dbx_rename = {"Name":"Name","Campaign":"Campaign","Mailing":"Mailing","Variant":"Variant","Subject_Line":"Subject Line","Segment":"Segment","Date":"Date","ESP":"ESP","Type_0":"Type 0","Type_1":"Type 1","Type_2":"Type 2","Send_Weekday":"Send Weekday","Sent":"Sent","Orders":"Orders","Revenue":"Revenue","Opens":"Opens","Total_Opens":"Total Opens","Clicks":"Clicks","Total_Clicks":"Total Clicks","Unsub":"Unsub","Complaints":"Complaints","Delivered":"Delivered","Bounces":"Bounces","Campaign_ID":"Campaign ID","Flow_Message_ID":"Flow Message ID","Flow_ID":"Flow ID","GA_Revenue":"GA Revenue","GA_Orders":"GA Order","GA_Sessions":"GA Session"}
    dbx_schema = ["Name","Campaign","Mailing","Variant","Subject Line","Segment","Date","ESP","Type 0","Type 1","Type 2","Send Weekday","Sent","Orders","Revenue","Opens","Total Opens","Clicks","Total Clicks","Unsub","Complaints","Delivered","Bounces","Campaign ID","Flow Message ID","Flow ID","GA Revenue","GA Order","GA Session"]
...
def update_bigquery(uri,client_id,client_esp):
    ...
    str_cols = ['Campaign','Mailing','Variant','Subject_Line','Segment','Type_2','Campaign_ID','ESP','Flow_Message_ID','Flow_ID',]
    int_cols = ['Sent','Delivered','Opens','Total_Opens','Clicks','Total_Clicks','Unsub','Complaints','Total_Bounces','Orders','Revenue',]
    missing_str_cols = ['Segment_Engagement','Segment_BNB','Segment_Freq','Error','Original_Segment','Send_Weekday','Test_Type','Offer']
    missing_int_cols =['AA_Visits','AA_Revenue','AA_SFCC_Demand','AA_Orders','AA_Mobile_Visits','Units','Product_Margin','Total_Margin','Bounces','Hard_Bounces','Soft_Bounces','FISCAL_YEAR','GA_Session']
