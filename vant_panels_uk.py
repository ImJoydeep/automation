...
client_name = 'Vant Panels UK'
dbx_path = '/Client/Vant Panels/Vant Panels UK/Internal Files/Reporting/'
...
def update_masterlist(uri,client_id,client_esp):
    ...
    error_result = ''
    # uri = '/home/nav93/Downloads/AlchemyWroxFiles/vant_panels_uk/2023-0806-0812/' #local
    ...
    print(masterlist_bigquery.shape)
