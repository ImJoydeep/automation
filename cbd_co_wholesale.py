...
def update_masterlist(uri,client_id,client_esp):
    ...
    error_result = ''
    # uri = '/home/nav93/Downloads/AlchemyWroxFiles/cbd_co_wholesale/2023_0625-0701/' #local
    ...
    rigger_analytics_data_rev_df = pd.DataFrame()
    ...
    print("shape",masterlist_bigquery.shape)
    ...
    files_list = [client_id+'-Campaign-Types.csv',client_id+'-Klaviyo-Campaigns.csv', client_id+'-Klaviyo-Flows.csv', client_id+'-Campaign-Analytics-rev.csv', client_id+'-Campaign-Analytics-ses.csv', 
