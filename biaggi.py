...
client_name = 'Biaggi'
dbx_path = '/Client/Biaggi/Internal Files/Reporting/Tableau/'
...
def update_masterlist(uri,client_id,client_esp):
    ...
    error_result = ''
    # uri = '/home/nav93/Downloads/AlchemyWroxFiles/Biaggi/2023_0820-0826/' #local
    ...
    masterlist_bigquery = pd.DataFrame()
    ...
    ## reading masterfile
    try:
        masterlist_bigquery = pd.read_csv(uri + 'Masterlist.csv',dtype={"Variant": str})
        masterlist_bigquery["Variant"] = masterlist_bigquery["Variant"].fillna('n/a')
    except Exception as e:
        print(e)
        error_result = error_result + ' ' + 'Masterlist.csv File Not Found'
        main_module.logs(dt_start,'Masterlist.csv', '0 rows', '0 rows', 'failed',client_id,client_esp)
        return(error_result)
    ...
    main_campaign_masterlist_df["Total_Recipients"] = main_campaign_masterlist_df["Sent"]
    # main_campaign_masterlist_df["Sent"] = np.nan
    ...
    main_trigger_masterlist_df["Total_Recipients"] = main_campaign_masterlist_df["Sent"]
    # main_trigger_masterlist_df["Sent"] = np.nan
    ...
    if not trigger_data_df_2.empty:
        ...
        main_trigger_masterlist_df_2["Total_Recipients"] = main_campaign_masterlist_df["Sent"]
        # main_trigger_masterlist_df_2["Sent"] = np.nan
    ...
    str_cols = ['Campaign','Mailing','Variant','Subject_Line','Segment','Type_2','Type_3','Campaign_ID','ESP','Flow_Message_ID','Flow_ID','Flow_Message_Name','Send_Weekday','Test_Type','Offer','By_Variant']
    int_cols = ['Sent','Delivered','Opens','Total_Opens','Clicks','Total_Clicks','Unsub','Complaints','Total_Bounces','Orders','Revenue','GA_Revenue','GA_Orders','GA_Sessions','Total_Recipients']
    ...
    dedup = updated_masterlist.loc[(updated_masterlist['Date'] >= filter_date)].drop_duplicates(subset=['Date','Name','Subject_Line','Segment','Variant','Flow_Message_Name','Flow_Message_ID','Flow_ID'], keep='last').sort_values('Date')
    ...
    dbx_rename = {"Name" :"Campaign Name","Campaign" :"By Campaign","Mailing" :"By Mailing","By_Variant" :"By Variant","Variant" :"Variant","Test_Type" :"Test_Type","Offer" :"Offer","Subject_Line" :"Subject","Segment" :"List","Date" :"Send Time","ESP" :"ESP","Type_0" :"Type 0","Type_1" :"Type 1","Type_2" :"Type 2","Type_3" :"Type 3","Send_Weekday" :"Send Weekday","Total_Recipients" :"Total Recipients","Orders" :"Unique Placed Order","Revenue" :"Revenue","Opens" :"Uniques Opens","Total_Opens" :"Total Opens","Clicks" :"Uniques Clicks","Total_Clicks" :"Total Clicks","Unsub" :"Unsubscribes","Complaints" :"Complaints","Delivered" :"Successful Deliveries","Total_Bounces" :"Total Bounces","Campaign_ID" :"Campaign ID","Winning_Variant_question_" :"Winning Variant?","Flow_Message_ID" :"Flow Message ID","Flow_ID" :"Flow ID","Flow_Message_Name" :"Flow Message Name","GA_Revenue" :"GA Revenue","GA_Orders" :"GA Order","GA_Sessions" :"GA Sessions"}
    dbx_schema = ["Campaign Name","By Campaign","By Mailing","By Variant","Variant","Test_Type","Offer","Subject","List","Send Time","ESP","Type 0","Type 1","Type 2","Type 3","Send Weekday","Total Recipients","Unique Placed Order","Revenue","Uniques Opens","Total Opens","Uniques Clicks","Total Clicks","Unsubscribes","Complaints","Successful Deliveries","Total Bounces","Campaign ID","Winning Variant?","Flow Message ID","Flow ID","Flow Message Name","GA Revenue","GA Order","GA Sessions"]
    dbx_masterlist = updated_masterlist.copy()
...
def update_bigquery(uri,client_id,client_esp):
    ...
    new_master['Sent'] = new_master['Total_Recipients']
